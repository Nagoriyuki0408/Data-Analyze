...
a = [131, 98, 125, 131, 124, 139, 131, 117, 128, 108, 135, 138, 131, 102, 107, 114, 119, 128, 121, 142, 127, 130, 124,
     ...
     106, 144, 110, 117, 137, 111, 104, 117, 100, 111, 101, 110, 105, 129, 137, 110, 112, 120, 113, 133, 112, 83, 94,
...
# 初始化分组宽度，并寻找合适的分组宽度
d = 2
while (max(a) - min(a)) % d != 0 or d <= lim:
    d += 1
...
# 绘制直方图
plt.hist(a, num_bins, rwidth=0.9)
...
# 设置x轴刻度，使用自定义字体并旋转45度
plt.xticks(range(min(a), max(a) + d, d), rotation=45, fontproperties=my_font)
